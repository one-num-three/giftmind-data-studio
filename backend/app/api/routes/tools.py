...
async def suggest_with_ai(payload: AIInput, session: DatabaseSession, _auth: ProtectedSession) -> dict:
    ...
    type_decision = infer_gift_type(payload.canonical_name, selected_type)
